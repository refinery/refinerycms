  ...
  describe Setting do
    ...
    context "set" do
      it "should create a setting that didn't exist" do
        ::Refinery::Setting.get(:creating_from_scratch, :scoping => 'rspec_testing').should == nil
        ::Refinery::Setting.set(:creating_from_scratch, {:value => "Look, a value", :scoping => 'rspec_testing'}).should == "Look, a value"
      end
      ...
      it "should default to form_value_type text_area" do
        @set = ::Refinery::Setting.set(:creating_from_scratch, {:value => "a value", :scoping => 'rspec_testing'})
        ::Refinery::Setting.find_by_name(:creating_from_scratch.to_s, :conditions => {:scoping => 'rspec_testing'}).form_value_type.should == "text_area"
      end
      ...
      it "should fix true as a value to 'true' (string)" do
        ...
        ::Refinery::Setting.find_by_name(:creating_from_scratch.to_s, :conditions => {:scoping => 'rspec_testing'})[:value].should == 'true'
        @set.should == true
      end
      ...
      it "should fix false as a value to 'false' (string)" do
        ...
        ::Refinery::Setting.find_by_name(:creating_from_scratch.to_s, :conditions => {:scoping => 'rspec_testing'})[:value].should == 'false'
        @set.should == false
      end
    ...
    context "find_or_set" do
      ...
      it "should work without scoping" do
        ::Refinery::Setting.find_or_set(:rspec_testing_creating_from_scratch, 'Yes it worked').should == 'Yes it worked'
      end
    end
