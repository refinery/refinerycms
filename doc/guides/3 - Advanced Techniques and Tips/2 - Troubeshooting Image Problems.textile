h1. Troubleshooting Refinery CMS and Dragonfly
...
Dragonfly depends on "Imagemagick":http://www.imagemagick.org/ to do graphics processing. Imagemagick is a standalone application which _must_ be installed on the application server. 

bq. If images are not working double-check that Imagemagick is installed.
...
bc. /system/images/W1siZiIsIjIwMTUvMDQvMjEvNjRlZ2d5MjJzcl9CdWxsd2lua2xlLmpwZyJdLFsicCIsInRodW1iIiwiMjI1eDI1NVx1MDAzZSJdXQ/Bullwinkle.jpg?sha=6ce3368c333342ff
...
bq. Decode the base64-encoded url to see what dragonfly should be doing


h3. Where are the images?
...
bq. Check that the file is still where Dragonfly saved it.
...
bc. D, [2015-04-29T12:41:22.505590 #23697] DEBUG -- : DRAGONFLY: shell command: 'convert' '/Applications/MAMP/www/rockythemoose/public/system/refinery/images/2015/04/21/64eggy22sr_Bullwinkle.jpg' '-resize' '225x255>' '/var/folders/xp/c9lbr76s6qs78fp4fxnxntrh0000gn/T/dragonfly20150429-23697-1hglgc2.jpg'
...
fn1. U003E is the unicode for ">". 

fn2. ">" is the Imagemagick geometry flag for "only shrink larger"
