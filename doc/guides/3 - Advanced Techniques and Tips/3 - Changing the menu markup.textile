...
Here we will implement a simple navigation bar for with markup for Foundation.

h2. Setup

Override the refinery file which creates the menu, and replace it with the 
