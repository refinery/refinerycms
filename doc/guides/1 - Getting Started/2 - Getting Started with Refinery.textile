...
These application templates are another very easy way to install Refinery, and allow for a great deal of control of your installation.  You can specific which version of Refinery that you wish to install simply by passing it to the command.

<shell>
$ rails new rickrockstar -m http://refinerycms.com/2-0
</shell>

TIP. You can specify other versions of Refinery in the same fashion.  <tt>$ rails new rickrockstar -m http://refinerycms.com/edge</tt>
