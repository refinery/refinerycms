...
On Linux, ImageMagick is usually included by default. On Mac OS X, use this "install script":https://github.com/maddox/magick-installer.
...
If you have all of these things, great! Proceed on to the "Getting Started with Refinery":/guides/getting-started-with-refinery/ guide.
...
Ruby 1.8.7 and Rubygems come installed by default on a mac. Lucky you!
...
Easier than expected right? Now you're ready to start building great websites with Refinery! Proceed on to the "Getting Started with Refinery":/guides/getting-started-with-refinery/ guide.
