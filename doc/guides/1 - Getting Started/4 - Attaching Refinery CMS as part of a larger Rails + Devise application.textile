...
+app/config/initializers/db_maintenance.rb+
<ruby>
...
For the refinery gem versions used in this guide, it was helpful to override a method in the admin base controller.
...
(This would be a problem if ExistingApp had custom routes for devise user sessions, for example. That was left out of this guide to keep things simpler.)
...
module ExistingApp
  ...
  ...
    ...
    config.to_prepare do
      ...
      Admin::BaseController.send :include, RestrictRefineryToRefineryUsers
      Admin::BaseController.send :before_filter, :restrict_refinery_to_refinery_users
