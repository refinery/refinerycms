...
<shell>
$ rails new rickrockstar -m http://refinerycms.com/t/2.0.0
</shell>
...
NOTE: In this guide we are using an SQLite3 database for data storage, because it is a zero-configuration database that works without effort. Refinery also supports MySQL and PostgreSQL "out of the box". For important applications, you may wish to use one of these other database systems. You can use another database systems by running the -d switch, or by changing the database.yml file after instance creation. If you choose to change the database.yml file, you may want to run the <shell>rake db:seed</shell> command to keep your instance consistent with this example.
...
!http://d2prewpsu45gft.cloudfront.net/system/images/BAhbB1sHOgZmSSI3MjAxMi8wMy8wNC8xNF8xMV8yNF85OTNfc2V0X3VwX3lvdXJfZmlyc3RfdXNlci5wbmcGOgZFVFsIOgZwOgp0aHVtYkkiCTYxMHgGOwZG/set-up-your-first-user.png!
...
!/system/images/BAhbBlsHOgZmSSJBMjAxMi8wMy8yNS8yM18yNV8xOF82ODVfcmVmaW5lcnlfZGVmYXVsdF9mcm9udF9lbmRfc21hbGwucG5nBjoGRVQ/refinery-default-front-end-small.png!
...
!/system/images/W1siZiIsIjIwMTAvMTIvMDIvMTJfMzJfNTFfODY0X2VkaXRpbmdfYWJvdXRfcGFnZV9zbWFsbC5wbmciXV0/12_32_51_864_editing_about_page_small.png!
...
!/system/images/W1siZiIsIjIwMTAvMTIvMDIvMTJfMzBfMDlfODJfZXZlbnRzX3BsdWdpbl9zbWFsbGVyLnBuZyJdXQ/12_30_09_82_events_plugin_smaller.png!
