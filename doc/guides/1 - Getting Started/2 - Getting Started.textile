...
TIP: If you are not using an RVM gemset and you have Rails 4 installed, be sure to read the "Rails Application Templates":#rails-application-templatesthese-application-templates-are-another-very-easy-way-to-install-refinery-and-allow-for-a-great-deal-of-control-of-your-installation-you-can-create-a-new-refinery-application-by-typing section below.
...
TIP. As *refinerycms is not compatible with Rails 4*, you may also need to specify the Rails version, especially if you are using rbenv instead of RVM to manage rubies: 

<shell>
$ rails _3.2.14_ new rickrockstar -m http://refinerycms.com/t/2.1.0
</shell>
