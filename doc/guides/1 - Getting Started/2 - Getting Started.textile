...
TIP: If you use rbenv instead of RVM and you have Rails 4 installed, be sure to read the "Rails Application Templates":#rails-application-templatesthese-application-templates-are-another-very-easy-way-to-install-refinery-and-allow-for-a-great-deal-of-control-of-your-installation-you-can-create-a-new-refinery-application-by-typing section below.
