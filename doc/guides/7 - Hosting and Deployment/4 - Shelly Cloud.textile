...
* Ruby, version 1.9.3 or higher. On Shelly Cloud default Ruby version
...
WARNING. Microsoft Windows isn't supported on Shelly Cloud. It's strongly 
discouraged to try this walkthrough on operating systems different than OS X or 
Linux.
