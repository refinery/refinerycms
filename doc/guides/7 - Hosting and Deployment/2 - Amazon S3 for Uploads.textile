...
h3. Final look at the file.

Depending on if you want the setting in production.rb, development.rb or application.rb 

Around the top of the file production file
<ruby>
MyApp::Application.configure do
  Refinery::Core.config.s3_backend = true
</ruby>

Lower in the application file.
<ruby>
