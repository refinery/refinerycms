...
Or by adding this directly to your +config/initializers/refinery/core.rb+ file the following syntax:
...
ensure it is added after the `config.s3_backend = !(ENV['S3_KEY'].nil? || ENV['S3_SECRET'].nil?)` line
