...
Now that you've got a Heroku account, install the Heroku gem and provide your account credentials:
...
If you haven't done so already, follow the first three steps of the "Heroku quick start guide":https://devcenter.heroku.com/articles/quickstart.
...
(make GitHub Issue: is that Ruby 1.9.3 warning still relevant? might Taps still throw errors, or can we remove that warning? it doesn't throw any 1.9.3-related errors for me. or maybe the previous person had the same problem I had but misdiagnosed it – they were using RVM and had the heroku gem installed in 1.9.2 but not 1.9.3.)
