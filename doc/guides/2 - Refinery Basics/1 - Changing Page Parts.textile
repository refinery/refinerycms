...
To add a new Page Part just to the home page, first we need to go into @config/initializers/refinery/pages.rb@. Find and uncomment the line <ruby> # config.new_page_parts = false </ruby> and set the value from "false" to "true"
