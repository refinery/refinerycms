...
<shell>
$ rails generate refinery:extension singular_model_name attribute:type [attribute:type ...]
</shell>

TIP: to see all the options supported by the +refinery:extension+ generator just run +rails g refinery:extension+.
...
<shell>
$ rails generate refinery:extension event title:string date:datetime photo:image blurb:text
</shell>
...
<shell>
  $ rails g refinery:extension place name:string --extension events --namespace events
</shell>
