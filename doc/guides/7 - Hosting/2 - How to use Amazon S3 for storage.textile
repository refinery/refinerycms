...
and uncomment this line in your Gemfile:
...
To turn on s3 storage, add this line to the _end_ of the appropriate environment file, for
example with production use +config/environments/production.rb+:
