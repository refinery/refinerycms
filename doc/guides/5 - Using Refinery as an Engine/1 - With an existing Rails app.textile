...
WARNING. This guide is based on Refinery CMS 3.0.0. Much of the code shown here will not work in earlier versions of Refinery.
...
Refinery doesn't ship with authentication by default, but you will need to add it
...
bq. Refinery and its associated gems should inserted after the standard rails, database and asset gems.
