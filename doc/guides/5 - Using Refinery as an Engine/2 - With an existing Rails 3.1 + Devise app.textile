...
To demonstrate another wrinkle you might discover, let's customize our use of Devise a tiny bit, by overriding the session controller to handle a before_action to prevent logging in when the database is undergoing maintenance.
...
class Users::SessionsController < Devise::SessionsController
  before_action :block_login_during_maintenance
