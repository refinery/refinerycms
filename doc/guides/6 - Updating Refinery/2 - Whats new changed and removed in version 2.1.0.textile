...
* Removed +Refinery::Pages.view_template_whitelist+ and +Refinery::Pages.use_view_templates+
configs and enabled setting per page view template to be active by default.
