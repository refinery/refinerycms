...
The requirement was to persist the data to the database, so we will start by creating a migration that will add a +show_in_footer+ column to the +refinery_pages+ database table. Open up terminal and type:
