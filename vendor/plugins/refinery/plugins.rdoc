...
To read more about how crudify works, checkout the crudify.rdoc file.
...
In our example above we extended Refinery to manage a products area. The problem is when I look at a product on the front end I get a URL like {http://localhost:3000/products/1} but I would really like it to be something like {http://localhost:3000/products/my-product}
