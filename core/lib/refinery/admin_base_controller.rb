...
module Refinery
  module AdminBaseController

    def self.included(controller)
      controller.send :include, ::Refinery::AdminBaseController::InstanceMethods
      controller.send :include, ::Refinery::AdminBaseController::ClassMethods
    end
