  ...
  describe Resources::Options do    
    describe ".reset!" do
      it "should set max_file_size back to the default value" do
        subject.class.max_file_size.should == subject.class::DEFAULT_MAX_FILE_SIZE
        subject.class.max_file_size += 1
        subject.class.max_file_size.should_not == subject.class::DEFAULT_MAX_FILE_SIZE
        subject.class.reset!
        subject.class.max_file_size.should == subject.class::DEFAULT_MAX_FILE_SIZE
      end
